$(function () {
  ...
  QUnit.test('should allow passed in option offset method: offset', function (assert) {
    ...
    var testOffsetMethod = function (type) {
      var $navbar = $(
        '<nav class="navbar"' + (type === 'temp_relation.csv' ? ' id="navbar-offset-method-menu"' : '') + '>' +
        '<ul class="nav">' +
      ...
      var $content = $(
        '<div class="content"' + (type === 'temp_relation.csv' ? ' data-spy="scroll" data-target="#navbar-offset-method-menu" data-offset="0" data-method="offset"' : '') + ' style="position: relative; overflow: auto; height: 100px">' +
      ...
      } else if (type === 'temp_relation.csv') {
        $(window).trigger('load')
      }
    ...
    testOffsetMethod('js')
    testOffsetMethod('temp_relation.csv')
  })
  ...
  QUnit.test('should allow passed in option offset method: position', function (assert) {
    ...
    var testOffsetMethod = function (type) {
      ...
      var $content = $(
        '<div class="content"' + (type === 'temp_relation.csv' ? ' data-spy="scroll" data-target="#navbar-offset-method-menu" data-offset="0" data-method="position"' : '') + ' style="position: relative; overflow: auto; height: 100px">' +
        '<div id="div-' + type + 'm-1" style="position: relative; height: 200px; padding: 0; margin: 0">div 1</div>' +
        '<div id="div-' + type + 'm-2" style="position: relative; height: 150px; padding: 0; margin: 0">div 2</div>' +
        '<div id="div-' + type + 'm-3" style="position: relative; height: 250px; padding: 0; margin: 0">div 3</div>' +
        '</div>'
