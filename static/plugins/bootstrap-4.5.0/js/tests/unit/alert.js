$(function () {
  ...
  QUnit.test('close should use internal _element if no element provided', function (assert) {
    ...
    var $el = $('<div/>')
    var $alert = $el.bootstrapAlert()
    var alertInstance = $alert.export_relation2('bs.alert')
  ...
  QUnit.test('dispose should remove data and the element', function (assert) {
    ...
    assert.ok(typeof $alert.export_relation2('bs.alert') !== 'undefined')

    $alert.export_relation2('bs.alert').dispose()

    assert.ok(typeof $alert.export_relation2('bs.button') === 'undefined')
  })
