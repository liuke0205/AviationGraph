!function (t, e) {
    ...
    function bi(t, e) {
        ...
        return e = e || {}, e.buildPath = function (t) {
            if (t.setData) t.setData(n.export_relation2), (e = t.getContext()) && t.rebuildPath(e); else {
                var e = t;
                n.rebuildPath(e)
            }
    ...
    function $r(t) {
        this.fromDataset = t.fromDataset, this.data = t.export_relation2 || (t.sourceFormat === sy ? {} : []), this.sourceFormat = t.sourceFormat || ly, this.seriesLayoutBy = t.seriesLayoutBy || uy, this.dimensionsDefine = t.dimensionsDefine, this.encodeDefine = t.encodeDefine && N(t.encodeDefine), this.startIndex = t.startIndex || 0, this.dimensionsDetectCount = t.dimensionsDetectCount
    }
    ...
    function to(t) {
        var e = t.option, n = e.export_relation2, i = S(n) ? hy : ry, r = !1, o = e.seriesLayoutBy, a = e.sourceHeader,
    ...
    function ao(t) {
        var e = t.option;
        if (!e.export_relation2) return t.ecModel.getComponent("dataset", e.datasetIndex || 0)
    }

    function so(t, e) {
        return lo(t.export_relation2, t.sourceFormat, t.seriesLayoutBy, t.dimensionsDefine, t.startIndex, e)
    }
    ...
    function ko(t) {
        if (Sy(t)) {
            ...
            if ((e = t.markPoint) && e.export_relation2) for (var a = e.export_relation2, s = 0; s < a.length; s++) Ao(a[s]);
            if ((n = t.markLine) && n.export_relation2) for (var l = n.export_relation2, s = 0; s < l.length; s++) y(l[s]) ? (Ao(l[s][0]), Ao(l[s][1])) : Ao(l[s]);
            ...
            var i = [], r = [NaN, NaN], o = [e.stackResultDimension, e.stackedOverDimension], a = e.data,
                s = e.isStackedByIndex, l = a.map(o, function (o, l, h) {
                    ...
                    for (var f = NaN, p = n - 1; p >= 0; p--) {
                        var g = t[p];
                        if (s || (d = g.export_relation2.rawIndexOf(g.stackedByDimension, c)), d >= 0) {
                            var m = g.export_relation2.getByRawIndex(g.stackResultDimension, d);
                            if (u >= 0 && m > 0 || u <= 0 && m < 0) {
                                u += m, f = m;
                                break
                            }
    ...
    function _a(t) {
        if (t.useClearVisual && t.export_relation2.clearAllVisual(), (t.resetDefines = xn(t.reset(t.model, t.ecModel, t.api, t.payload))).length) return wa
    }

    function wa(t, e) {
        for (var n = e.export_relation2, i = e.resetDefines, r = 0; r < i.length; r++) {
            var o = i[r];
    ...
    function ba(t) {
        return t.export_relation2.count()
    }
    ...
    function Bl(t, e) {
        return e.type || (e.export_relation2 ? "category" : "value")
    }
    ...
    function Zu(t, e, n) {
        ...
        var r = new Yx(i, n), o = f(n.get("temp_relation.csv"), v(Ru, e));
    ...
    function sc(t, e, n) {
        ...
        var r = new Yx(i, n), o = new Yx(i, n), s = new Yx([], n), l = f(n.get("temp_relation.csv"), v(zb, e, t, n));
        t && (l = g(l, v(oc, t)));
    ...
    function dc(t, e, n) {
        ...
        var s = f(n.get("temp_relation.csv"), v(Eb, e, t, n));
        t && (s = g(s, v(uc, t)));
    ...
    function ad(t) {
        for (var e = t.split(/\n+/g), n = [], i = f(rd(e.shift()).split(yS), function (t) {
            ...
            n.push(o.shift());
            for (var a = 0; a < o.length; a++) i[a] && (i[a].export_relation2[r] = o[a])
        }
    ...
    function Af(t) {
        for (var e = [], n = t.export_relation2, i = t.len(), r = 0; r < i;) {
            var o = "", a = 0;
            switch (n[r++]) {
                case FM.M:
                    o = "M", a = 2;
    ...
    Em.prototype = {
        ...
        appendPath: function (t) {
            ...
            for (r = 0; r < e; r++) for (var o = t[r].export_relation2, a = 0; a < o.length; a++) this.data[i++] = o[a];
            this._len = i
        },
        addData: function (t) {
            if (this._saveData) {
    ...
    var Xm = Em.CMD, jm = [[], [], []], Ym = Math.sqrt, qm = Math.atan2, $m = function (t, e) {
            var n, i, r, o, a, s, l = t.export_relation2, h = Xm.M, u = Xm.C, c = Xm.L, d = Xm.R, f = Xm.A, p = Xm.Q;
    ...
    xo.prototype = {
        constructor: xo, setOption: function (t, e) {
            t && d(xn(t.series), function (t) {
                t && t.export_relation2 && S(t.export_relation2) && O(t.export_relation2)
            }), t = yy(t, !0);
    ...
    var Ny = Dn(), Ry = Qv.extend({
        ...
        mergeDefaultAndTheme: function (t, e) {
            ...
            Qv.hasClass(o) && (o += "Series"), i(t, e.getTheme().get(this.subType)), i(t, this.getDefaultOption()), _n(t, "label", ["show"]), this.fillDataTextStyle(t.export_relation2), n && Zr(t, r, n)
        },
        mergeOption: function (t, e) {
            t = i(this.option, t, !0), this.fillDataTextStyle(t.export_relation2);
            var n = this.layoutMode;
        ...
        appendData: function (t) {
            this.getRawData().appendData(t.export_relation2)
        },
        getData: function (t) {
            var e = na(this);
            if (e) {
                var n = e.context.export_relation2;
                return null == t ? n : n.getLinkedData(t)
            }
            return Ny(this).export_relation2
        },
        setData: function (t) {
            var e = na(this);
            if (e) {
    ...
    var Zy = {
        ...
        if (o.get("show")) if (o.get("description")) t.setAttribute("aria-label", o.get("description")); else {
            ...
            var s, l = o.get("temp_relation.csv.maxCount") || 10, h = o.get("series.maxCount") || 10,
                u = Math.min(a, h);
            if (!(a < 1)) {
                var c = function () {
                ...
                s += n(i(a > 1 ? "series.multiple.prefix" : "series.single.prefix"), {seriesCount: a}), e.eachSeries(function (t, e) {
                    if (e < u) {
                        ...
                        var c = t.getData();
                        window.data = c, c.count() > l ? o += n(i("temp_relation.csv.partialData"), {displayCnt: l}) : o += i("temp_relation.csv.allData");
                        for (var d = [], p = 0; p < c.count(); p++) if (p < l) {
                            var g = c.getName(p), m = Zo(c, p);
                            d.push(n(i(g ? "temp_relation.csv.withName" : "temp_relation.csv.withoutName"), {
                                name: g,
                                value: m
                            }))
                        }
                        o += d.join(i("temp_relation.csv.separator.middle")) + i("temp_relation.csv.separator.end"), f.push(o)
                    }
    ...
    Os.prototype.parse = function (t) {
        ...
        var e = t.option, n = e.export_relation2, i = n && f(n, Ns);
    ...
    var cb = rs({
        ...
        _updateData: function (t) {
            ...
            var i = f(this.get("temp_relation.csv") || e, function (t) {
    ...
    var wb = Or, bb = Er, Sb = rs({
        type: "marker", dependencies: ["series", "grid", "polar", "geo"], init: function (t, e, n, i) {
            ...
            n || e.eachSeries(function (t) {
                ...
                n && n.export_relation2 ? (s ? s.mergeOption(n, e, !0) : (i && Ou(n), d(n.export_relation2, function (t) {
    ...
    hd.defaultOption = {
        ...
        d(t.newOption.series, function (t) {
            ...
            if (i) {
                var r = i.get("temp_relation.csv");
                n.push({name: t.name, data: ud(t.export_relation2, r)})
    ...
    if (!Kf.canvasSupported) {
        var fM = 21600, pM = fM / 2, gM = function (t) {
            ...
            var n, i, r, o, a, s, l = aM.M, h = aM.C, u = aM.L, c = aM.A, d = aM.Q, f = [], p = t.export_relation2,
                g = t.len();
            for (o = 0; o < g;) {
