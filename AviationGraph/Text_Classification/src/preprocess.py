...
from AviationGraph.Text_Classification.src.config import Config
import jieba
...
class preprocesser(object):
    ...
    def get_category_id(self):
        ...
        #                     '作用或影响关系']
        # ['主演', '连载网站', '作者', '歌手', '导演', '编剧', '出品公司', '出版社', '作词', '作曲', '所属专辑', '主持人', '上映时间', '改编自', '制片人', '主角', '嘉宾']
        # ['身高', '出生日期', '国籍', '出生地', '朝代', '妻子', '丈夫', '民族', '毕业院校', '父亲', '母亲', '字', '号', '祖籍']
        # ['成立日期', '总部地点', '创始人', '注册资本', '简称', '董事长']
        # ['海拔', '气候', '所在城市', '人口数量', '面积', '占地面积', '首都', '官方语言', '邮政编码']
        categories = ['主演', '连载网站', '作者', '歌手', '导演', '编剧', '出品公司', '出版社', '作词', '作曲', '所属专辑', '主持人', '上映时间', '改编自', '制片人', '主角', '嘉宾']
